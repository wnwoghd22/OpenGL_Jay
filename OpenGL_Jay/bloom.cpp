...
int main()
{
    ...
    // -------------------------
    Shader shader("7.bloom.vs", "7.bloom_fs.txt");
    Shader shaderLight("7.bloom.vs", "7.light_box_fs.txt");
    Shader shaderBlur("7.blur.vs", "7.blur_fs.txt");
    Shader shaderBloomFinal("7.bloom_final.vs", "7.bloom_final_fs.txt");
